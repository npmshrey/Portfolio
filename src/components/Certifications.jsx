...
export default function Certifications() {
  return (
    <section id="certifications" className="py-20 border-t border-[#E5E5E5] bg-white relative w-full overflow-hidden">
      <div className="max-w-4xl mx-auto px-8">
        <div className="mb-10 text-left">
          ...
          >
            Professional <span className="font-light text-[#999]">Certifications.</span>
          </motion.h3>
        </div>
